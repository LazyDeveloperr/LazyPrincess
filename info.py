...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Armann:arru11992288@cluster0.h39zhbf.mongodb.net/?retryWrites=true&w=majority")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002088181161')).split()]
