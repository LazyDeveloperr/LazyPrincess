...
BOT_TOKEN = environ['7146331240:AAHTD2Yri7rNf0jLg4zp_eQ4WoAEq0bM6DY']
...
# Others
LOG_CHANNEL = int(environ.get('-1002033412969', 0))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002061434106')).split()]
