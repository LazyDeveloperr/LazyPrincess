...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://bit.ly/RbyLinkzz"),
            ],
            [
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('🔔 𝗔𝗱𝗺𝗶𝗻 🤖', url='https://t.me/RbyAdminBot')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
